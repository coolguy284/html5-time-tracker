  ...
  */
  ...
  static getLatestVer() {
    ...
    return {
      ...
      binary: latestVer.format == 'binary',
    };
  }
  ...
  #attemptLoadFromMedium() {
    ...
    if (successfulRead) {
      ...
      this.#mediumMajorVer = storageVersion.major;
      this.#mediumMinorVer = storageVersion.minor;
      this.#mediumBinary = storageVersion.format == 'binary';
  ...
  #saveToMedium() {
    ...
    try {
      versionSaver.transmuteVersion({
        major: this.#mediumMajorVer,
        minor: this.#mediumMinorVer,
        format: this.#mediumBinary ? 'binary' : 'json',
      });
    } catch (e) {
      console.error(e);
      return false;
  ...
  setEventButtons(newEventButtons) {
    this.#loadIfNotAlready();
    this.#eventButtons = PlannerPersistentStorage.#deepClone(newEventButtons);
    this.#jsDispatchEvent(new CustomEvent('eventButtonsUpdate'));
    this.saveOrCreateNew();
  }
